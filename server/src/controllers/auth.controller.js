...
async function loginWithGoogle(req,res){
    try{
        ...
        return res.status(200)
                  ...
                  .cookie("refreshToken", refreshToken, {httpOnly: true, sameSite: 'None', secure: true, path: '/api/auth/tokenRefresh'})
...
async function logout(req,res){
    ...
    return res.status(200)
              ...
              .clearCookie("refreshToken", {httpOnly: true, sameSite: 'None', secure: true, path: '/api/auth/tokenRefresh'})
